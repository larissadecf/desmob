...
package br.usjt.activitya.util;
...
public class Utils {
    ...
    public static br.usjt.activitya.util.StatusTracker mStatusTracker;

    static {
        mStatusTracker = br.usjt.activitya.util.StatusTracker.getInstance();
    }
